...
var _findReactNativeScripts = _interopRequireDefault(
  require('../util/findReactNativeScripts')
);
...
function link([rawPackageName], ctx, opts) {
  ...
  const dependencyConfig = (0, _getDependencyConfig.default)(
    ctx,
    platforms,
    packageName
  );
  const tasks = [
    () =>
      (0, _promisify.default)(
        dependencyConfig.commands.prelink || _commandStub.default
      ),
    () => (0, _linkDependency.default)(platforms, project, dependencyConfig),
    () =>
      (0, _promisify.default)(
        dependencyConfig.commands.postlink || _commandStub.default
      ),
    () => (0, _linkAssets.default)(platforms, project, dependencyConfig.assets)
  ];
