...
var _getPlatforms = _interopRequireWildcard(require('../core/getPlatforms'));
  ...
  Object.keys(platforms || {}).forEach(platform => {
    ...
    if (!isInstalled) {
      _logger.default.info(
        `${(0, _getPlatforms.getPlatformName)(
          platform
    ...
    _logger.default.info(
      `Unlinking "${packageName}" ${(0, _getPlatforms.getPlatformName)(
        platform
      )} dependency`
    );
    ...
    _logger.default.info(
      `${(0, _getPlatforms.getPlatformName)(platform)} module "${
        dependency.name
...
function unlink(args, ctx) {
  ...
  const allDependencies = (0, _getProjectDependencies.default)(ctx.root).map(
