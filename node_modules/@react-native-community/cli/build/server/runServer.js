...
var _messageSocket = _interopRequireDefault(require('./util/messageSocket'));

var _webSocketProxy = _interopRequireDefault(require('./util/webSocketProxy'));

var _MiddlewareManager = _interopRequireDefault(
  require('./middleware/MiddlewareManager')
);

var _loadMetroConfig = _interopRequireDefault(
  require('../util/loadMetroConfig')
);
...
async function runServer(argv, ctx, args) {
  ...
  middlewareManager
    .getConnectInstance()
    .use((0, _morgan().default)('combined'));
  ...
  const wsProxy = _webSocketProxy.default.attachToServer(
    serverInstance,
    '/debugger-proxy'
  );
